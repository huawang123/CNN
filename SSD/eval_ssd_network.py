...
tf.app.flags.DEFINE_string(
    'checkpoint_path', '/home/wanghua/new/first/rcnn/train/pascalvoc_2007/',
    'The directory where the model was written to or an absolute path to a '
    'checkpoint file.')
tf.app.flags.DEFINE_string(
    'eval_dir', '/home/wanghua/new/first/rcnn/eval/pascalvoc_2007', 'Directory where the results are saved to.')
tf.app.flags.DEFINE_integer(
