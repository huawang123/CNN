...
import model_segnet as model

FLAGS = tf.app.flags.FLAGS

tf.app.flags.DEFINE_string('testing', '', """ checkpoint file """)
tf.app.flags.DEFINE_string('finetune', '/home/wh/Tensorflow-SegNet/log/model.ckpt-8999', """ finetune checkpoint file """)
tf.app.flags.DEFINE_integer('batch_size', "5", """ batch_size """)
tf.app.flags.DEFINE_float('learning_rate', "1e-4", """ initial lr """)
tf.app.flags.DEFINE_float('moving_average_decay', "0.9999", """ moving_average_decay """)
tf.app.flags.DEFINE_string('log_dir', "/home/wh/Tensorflow-SegNet/log", """ dir to store ckpt """)
tf.app.flags.DEFINE_string('image_dir', "/home/wh/SegNet-Tutorial/CamVid/train.txt", """ path to CamVid image """)
tf.app.flags.DEFINE_string('test_dir', "/home/wh/SegNet-Tutorial/CamVid/test.txt", """ path to CamVid test image """)
tf.app.flags.DEFINE_string('val_dir', "/home/wh/SegNet-Tutorial/CamVid/val.txt", """ path to CamVid val image """)
tf.app.flags.DEFINE_integer('max_steps', "20000", """ max_steps """)
tf.app.flags.DEFINE_integer('num_val', "101", """ num_val """)
...
tf.app.flags.DEFINE_integer('num_class', "12", """ total class number """)
...
tf.app.flags.DEFINE_integer('min_after_dequeue',"10000", "min_after_dequeue")
