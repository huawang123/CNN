...
if __name__ =='__main__':
    ...
    img_path = './FlowerData/17flowers/jpg/image_0561.jpg'  # or './17flowers/jpg/16/****.jpg'
    imgs, verts = process_data.image_proposal(img_path)
    process_data.show_rect(img_path, verts, ' ', 'a')
    ...
    for f in features:
        for svm in svms:
            ...
            if pred[0] != 0:
                ...
                if Reg_box_solver.predict([f.tolist()])[0][0] > 0.3:
    ...
    process_data.show_rect(img_path, results_old,' ', 'b')
    process_data.show_rect(img_path, average_result,flower[result_label], 'c')
