...
def show_rect(img_path, regions, message, name):
    '''
    ...
    plt.imshow(img)
    plt.show()
    plt.savefig('./%s.jpg' % name, dpi=600)
        ...
        if os.path.isfile(save_path):
            ...
            with codecs.open(self.train_list, 'r', 'utf-8') as f:
                ...
                for num, line in enumerate(lines):
                    ...
                    image_path_split = image_path.strip().split('/')
                    image_path = os.path.join(self.data, image_path_split[0] , image_path_split[1] , image_path_split[3])
                    index = int(context[1])
    ...
    def load_2flowers(self):
        with codecs.open(self.fineturn_list, 'r', 'utf-8') as f:
            ...
            for num, line in enumerate(lines):
                ...
                image_path = context[0]
                image_path_split = image_path.strip().split('/')
                image_path = os.path.join(self.data, image_path_split[0], image_path_split[3])
